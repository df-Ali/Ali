...
- **Python** — Advanced level, strong algorithmic and problem-solving skills
- **Django** — Currently learning backend web development
- **C++** — Currently learning, working on algorithmic problems
...
- [Fibonacci](https://github.com/df-Ali/Fibonacci) — A C++ program that calculates Fibonacci numbers
### 🌱 Currently Learning
Django and C++, with a focus on building real-world backend projects.

### 📫 How to reach me
Feel free to check out my repositories and follow along with my progress!
